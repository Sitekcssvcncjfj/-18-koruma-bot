...
SE_USER = os.getenv("SE_SECRET")  # DÜZELTİLDİ: SE_SECRET olmalı
SE_SECRET = os.getenv("SE_USER")  # DÜZELTİLDİ: SE_USER olmalı
# =====================================================
